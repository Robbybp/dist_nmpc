...
# ---- 
m.time        = Param(initialize=100)                # hours of operation? 
...
m.LT1 = Var(m.fe,initialize=LT1_dict)
VB1_dict = {}
for i in m.fe: VB1_dict[i] = 4.008
m.VB1 = Var(m.fe,initialize=VB1_dict)
...
m.LT2 = Var(m.fe,initialize=2.13827)
m.VB2 = Var(m.fe,initialize=2.40367)
